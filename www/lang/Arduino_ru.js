...
Blockly.Msg.CAT_ARDUINO_COMM_SERIAL = "- Серийный порт";
Blockly.Msg.CAT_ARDUINO_COMM_SOFTSERIAL = "- Программный Серийный порт";
...
Blockly.Msg.CAT_DFRobot_SHIELD_LCDKEYPAD = "▀ LCD Экран";
...
Blockly.Msg.CAT_BARGRAPH = "Гистограмма";
...
Blockly.Msg.on_off = [["вкл", "НИЗКИЙ"], ["выкл", "ВЫСОКИЙ"]];
...
Blockly.Msg.LKL_DROPDOWN = [['нарастающий фронт', 'RISING'], ['ниспадающий фронт', 'FALLING'], ['изменяющееся состояние', 'CHANGE'],['ВЫСОКОЕ состояние','ВЫСОКИЙ'], ['НИЗКОЕ состояние','НИЗКИЙ']];
...
Blockly.Msg.ARDUINO_INOUT_Pulsein = "возвращает длительность в микросекундах импульса УВЕЛИЧЕНИЯ или УМЕНЬШЕНИЯ, подаваемого на вывод. Если значение параметра ВЫСОКОЕ, блок ожидает, пока вывод достигнет высокого уровня, затем запускает синхронизацию, ожидает, пока вывод вернется к низкому уровню, а затем останавливает синхронизацию";
Blockly.Msg.ARDUINO_BASE_DELAY = "⏲ ждать";
Blockly.Msg.ARDUINO_BASE_DELAY_TOOLTIP = "Укажите время ожидания в секундах, миллисекундах или микросекундах. \n Ппрограмма больше ничего не делает в течение этого времени";
Blockly.Msg.millis1 = "продолжительность в";
Blockly.Msg.millis2 = "с самого начала";
Blockly.Msg.ARDUINO_SINCE_PROGRAM_STARTED_TOOLTIP = "озвращает длительность в миллисекундах, секундах или микросекундах с момента запуска программы";
